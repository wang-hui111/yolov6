...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--weights', type=str, default='/home/wanghui/桌面/YOLOv6-main/yolov6s.pt', help='model path(s) for inference.')
    parser.add_argument('--source', type=str, default='/home/wanghui/桌面/YOLOv6-main/data/images/image1.jpg', help='the source path, e.g. image-file/dir.')
    ...
    parser.add_argument('--save-img', default=True,action='store_false', help='save visuallized inference results.')
